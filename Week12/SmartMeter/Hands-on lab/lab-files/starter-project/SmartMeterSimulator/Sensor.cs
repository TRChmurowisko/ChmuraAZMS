...
namespace SmartMeterSimulator
{
    ...
    class Sensor
    {
        ...
        {
            //xTODO: 17. Connect the Device to Iot Hub by creating an instance of DeviceClient
        ...
        public async void SendMessageAsync()
        {
            ...
            //xTODO: 18.Serialize the telemetryDataPoint to JSON
            var messageString = JsonConvert.SerializeObject(telemetryDataPoint); 

            //xTODO: 19.Encode the JSON string to ASCII as bytes and create new Message with the bytes
            var message = new Message(Encoding.ASCII.GetBytes(messageString));

            //xTODO: 20.Send the message to the IoT Hub
